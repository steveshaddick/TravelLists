...
Location.prototype.showHide = function(e) {
    ...
    if (t.isOpen) {
        t.cancelNote();
        $(".notes-hidden .number", t.$element).html(t.totalNotes);
        $(".notes-wrapper", t.$element).slideUp();
        $(".notes-hidden", t.$element).show();
        t.isOpen = false;
        t.$showHideButton.html("+").attr("title", "Expand");
    } else {
        $(".notes-wrapper", t.$element).slideDown();
        $(".notes-hidden", t.$element).hide();
        t.isOpen = true;
        t.$showHideButton.html("&#150;").attr("title", "Collapse");
    }
    return false;
};
...
var EditMode = function() {
    ...
    function n() {
        ...
        $("#addLocationButton").click(a);
        $(document).on("click", ".delete-location-button", r).on("click", ".location-up", c).on("click", ".location-down", c);
        $("#editDoneButton").click(i);
    ...
    function a() {
        ...
        Modal.load("/views/modal/addLocation.html", function() {
            ...
            Modal.jQ(".submit-location-link").click(l);
            Modal.jQ(".cancel-link").click(s);
        }, "location-modal");
        return false;
    }
    function l() {
